...
const GetInvolved = () => (
  <Layout>
    ...
    <Container className="mb-5 mt-5">
      ...
      <Col md={7}>
        <p className="lead">
          If you attend CBC we are listed under adult groups at CBC. You may
          list as an interested party and email the Threads of Love at CBC
          ministry group. You will be contacted by our director, Linda Coward,
          or other members, either by phone, email, depending on the information
          given.
        </p>
        <p>
